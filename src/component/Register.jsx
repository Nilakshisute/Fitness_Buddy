        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="px-6 pt-6 pb-2">
            <div className="text-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-800">Join Fitness Buddy</h2>
          ...
          <div className="px-6 pb-6">
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 text-sm rounded-md border ${
                    passwordError ? "border-red-300 focus:ring-red-500" : "border-gray-300 focus:ring-teal-500"
              ...
              <div className="flex items-center">
                ...
                <label htmlFor="terms" className="ml-2 block text-xs text-gray-700">
                  I agree to the <a href="/terms" className="text-teal-600 hover:text-teal-800">Terms</a> and <a href="/privacy" className="text-teal-600 hover:text-teal-800">Privacy Policy</a>
                </label>
              </div>
            ...
            <div className="flex items-center mt-4 mb-4">
              ...
              <span className="flex-shrink mx-3 text-gray-400 text-xs">Or register with</span>
              <div className="flex-grow border-t border-gray-200"></div>
            </div>
            ...
            <div className="text-center mt-4">
              <p className="text-xs text-gray-600">
                ...
                <a href="/login" className="text-teal-600 hover:text-teal-800 font-medium transition">
                  Sign in
                </a>
              </p>
            </div>
